 ...
 * @author      G Janssens
 */
class Plopcom_Insta_Model_Resource_Post_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
     ...
     * @return Plopcom_Insta_Model_Resource_Post_Collection
     * @author G Janssens
     */
    ...
    protected function _renderFiltersBefore()
    {
        if ($this->getFilter('store')) {
            $this->getSelect()->join(
                array('store_table' => $this->getTable('plopcom_insta/post_store')),
